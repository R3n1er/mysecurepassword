              ...
              <div className="relative space-y-8">
                ...
                <div className="msp-card p-6">
                  ...
                  <div className="space-y-4 msp-text-white/90 leading-relaxed">
                    <p>
                      <strong>Date de dernière mise à jour :</strong> Décembre
                      2024
                    </p>
                    <p>
                      <strong>Éditeur :</strong> MySecurePassword
                    </p>
                    <p>
                      <strong>Type d&apos;application :</strong> Générateur de mots
                      de passe sécurisés
                    </p>
                    <p>
                      MySecurePassword est une application web gratuite de
                      génération de mots de passe sécurisés, développée en
                      France et conforme au Règlement Général sur la Protection
                      des Données (RGPD).
                    </p>
                  </div>
                </div>
                ...
                <div className="msp-card p-6">
                  ...
                  <div className="space-y-4 msp-text-white/90 leading-relaxed">
                    <div className="bg-green-500/20 border border-green-500/40 rounded-xl p-4">
                      ...
                      <p>
                        <strong>
                          MySecurePassword ne collecte, ne stocke et ne transmet
                ...
                <div className="msp-card p-6">
                  ...
                  <div className="space-y-4 msp-text-white/90 leading-relaxed">
                    <p>
                                                 MySecurePassword utilise uniquement des cookies techniques
                           essentiels au fonctionnement de l&apos;application :
                    </p>
                    <div className="bg-white/5 border border-white/20 rounded-xl p-4">
                      <h4 className="font-bold text-white mb-2">
                      ...
                      <ul className="space-y-2">
                        <li>
                          <strong>Session :</strong> Maintien de la session
                          utilisateur (supprimé à la fermeture)
                        </li>
                        <li>
                          <strong>Préférences :</strong> Sauvegarde des
                          paramètres de configuration (local)
                        </li>
                        <li>
                          <strong>Sécurité :</strong> Protection CSRF
                ...
                <div className="msp-card p-6">
                  ...
                  <div className="space-y-4 msp-text-white/90 leading-relaxed">
                    <p>
                      Notre approche de sécurité garantit la protection maximale
                      de vos données :
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="bg-white/5 border border-white/20 rounded-xl p-4">
                ...
                <div className="msp-card p-6">
                  ...
                  <div className="space-y-4 msp-text-white/90 leading-relaxed">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-3">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <strong>Droit d&apos;accès :</strong> Accéder aux données
                            vous concernant
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <strong>Droit d&apos;effacement :</strong> Supprimer vos
                            données
                          </div>
                        </div>
                      </div>
                      <div className="space-y-3">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <strong>Droit de portabilité :</strong> Récupérer
                            vos données
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                    ...
                    <div className="bg-yellow-500/20 border border-yellow-500/40 rounded-xl p-4">
                      ...
                      <p>
                        <strong>
                          Comme MySecurePassword ne collecte aucune donnée
                          personnelle, l&apos;exercice de ces droits n&apos;est pas
                          applicable.
                        </strong>{" "}
                        Vous gardez un contrôle total sur vos données car elles
                ...
                <div className="msp-card border-2 border-white/20 p-6">
                  ...
                  <div className="space-y-4 msp-text-white/90 leading-relaxed">
                    <p>
                      ...
                      confidentialité ou vos droits en matière de protection des
                      données :
                    </p>
                    <div className="bg-white/5 border border-white/20 rounded-xl p-4">
                      <h4 className="font-bold text-white mb-2">
                      ...
                      <ul className="space-y-2">
                        <li>
                          <strong>Formulaire de contact :</strong> Disponible en
                          bas de page
                        </li>
                        <li>
                        ...
                        <li>
                          <strong>Documentation :</strong> Consultable dans le
                          projet open source
                        </li>
                      </ul>
                    </div>
                    <p className="text-sm">
                      ...
                      répondre dans les 72 heures conformément aux exigences du
                      RGPD.
                    </p>
                  </div>
                </div>
